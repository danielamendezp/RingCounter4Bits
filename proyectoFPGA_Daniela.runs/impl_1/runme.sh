...
HD_PWD='E:/III Cuatrimestre 2022/FPGA/Tareas/Proyecto/proyectoFPGA_Daniela_Rodrigo_Keylor/proyectoFPGA_Daniela_Rodrigo_Keylor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ContadorAnillo4bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ContadorAnillo4bits.tcl -notrace
